...
const index = () => {
  ...
  <div className="footer-main">
    <div className="footer-container">
      ...
      {/* <!-- Right Column: Quick Links (2 Grid Columns) --> */}\
      ...
      <div className="footer-links-wrapper">
        ...
        <ul className="footer-links-list">
          ...
          <li><a href="#">Blog</a></li>
          <li><a href="#">Chopped Carbon Fiber</a></li>
          <li><a href="#">Contact</a></li>
          <li><a href="#">Phlex Carbon CFTM</a></li>
          <li></li> 
		  {/* <!-- Empty space for grid alignment --> */}
          <li><a href="#">Phlex Carbon CFM</a></li>
          <li></li>
          <li><a href="#">Phelx Carbon SPCF 12K Tow</a></li>
          <li></li>
          <li><a href="#">Fiber Sizing Compounds</a></li>
        </ul>
      </div>
...
// 	return (
// 		<footer classNameName="font-inter mt-12 border-t border-[#ededed] text-neutral-500">
// 			<div classNameName="mx-auto flex min-h-[76px] w-[calc(100%-48px)] max-w-[1248px] flex-col items-center justify-between gap-5 py-6 sm:flex-row sm:py-0">
// 				<div classNameName="flex items-center gap-4 text-sm leading-4">
...
// 								classNameName="underline-offset-4 hover:underline"
// 							/>
// 						</>
// 					)}
// 				</div>
...
// 										classNameName="flex size-7 items-center justify-center transition-colors hover:text-black"
// 									>
